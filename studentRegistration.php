...
<form id="stuRegForm">
    <div class="form-group">
        ...
        <input type="text" class="form-control"placeholder="Name" name="stuname"id="stuname"><br>
    </div>
    ...
    <div class="form-group">
        ...
        <small class="form-text">We'll never share your email with anyone else.</small><br><br>
    </div>
